...
import './App.css';
import artboard from "../src/assets/icons/artboard.png";
import blur from "../src/assets/icons/blur.png";
...
import cir from "../src/assets/icons/cir.png";
import circle from "../src/assets/icons/circle.png";
import crop from "../src/assets/icons/crop.png";
import cross from "../src/assets/icons/cross.png";
import dodge from "../src/assets/icons/dodge.png";
import edit from "../src/assets/icons/edit.png";
import eraser from "../src/assets/icons/eraser.png";
import eye from "../src/assets/icons/eye.png";
import eyes from "../src/assets/icons/eyes.png";
import gradient from "../src/assets/icons/gradient.png";
import hand from "../src/assets/icons/hand.png";
import healing from "../src/assets/icons/healing.png";
import history from "../src/assets/icons/history.png";
import image from "../src/assets/icons/image.png";
import lasso from "../src/assets/icons/lasso.png";
import lock from "../src/assets/icons/lock.png";
import mag from "../src/assets/icons/mag.png";
import magic from "../src/assets/icons/magic.png";
import max from "../src/assets/icons/max.png";
import min from "../src/assets/icons/min.png";
import move from "../src/assets/icons/move.png";
import path from "../src/assets/icons/path.png";
import pen from "../src/assets/icons/pen.png";
import rectangle from "../src/assets/icons/rectangle.png";
import scale1 from "../src/assets/icons/scale1.png";
import scale2 from "../src/assets/icons/scale2.png";
import selection from "../src/assets/icons/selection.png";
import stamp from "../src/assets/icons/stamp.png";
import text from "../src/assets/icons/text.png";
import trans from "../src/assets/icons/trans.png";
import tri from "../src/assets/icons/tri.png";
      ...
      <div className="toolbar d-flex flex-column p-3">
        ...
        <div className="tool-buttons d-flex flex-column gap-2">
          ...
          <button className="btn btn-sm btn-warning" onClick={handleUndo} title="Undo (Ctrl+Z)">
            <img className="spcross" src={cross} alt="undo" /> 
          </button>
          ...
          <button className="btn btn-sm btn-info" onClick={handleZoomOut} title="Zoom Out (-)">
            🔍 <img className="spcross" src={min} alt="zoom-out" /> 
          </button>
